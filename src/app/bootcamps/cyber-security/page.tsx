...
export default function CyberSecurityBootcampPage() {
  const [formData, setFormData] = useState({
    ...
    phone: "",
    organization: "",
    interest: "Cyber Security Bootcamp",
    message: ""
  });
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          message: formData.message || "Enquiry for Cyber Security Bootcamp details",
        }),
      });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6">
              ...
              <p className="font-sans text-base sm:text-lg md:text-[20px] leading-relaxed text-[#121212] font-semibold">
                Defend systems. Hunt threats. Engineer resilience across modern enterprise attacks.
              </p>

              <p className="font-sans text-[14.5px] sm:text-base leading-relaxed text-[#555555] max-w-2xl">
                Enterprise security is not theoretical knowledge. It is hands-on detection engineering, SIEM tuning, red team penetration testing, and zero trust architecture. This 16-module intensive bootcamp builds practitioners capable of protecting critical digital assets.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                {[
                  ...
                  { label: "Red & Blue Teams", sub: "Offensive & defense" },
                  { label: "SOC & SIEM", sub: "Threat detection" },
                  { label: "Full Capstone", sub: "Enterprise defense" }
                ].map((stat, i) => (
              ...
              <div className="w-full max-w-md bg-white rounded-2xl border-2 border-[#121212]/15 p-6 sm:p-8 shadow-xl space-y-6 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-xs text-[#666666]">Enterprise Cyber Defense Engineer</p>
                  </div>
                </div>

                <div className="space-y-3 font-sans text-xs sm:text-[13.5px] text-[#333333]">
                  {[
                    "Harden network perimeters, IAM, and enterprise zero trust architecture",
                    "Tune SIEM correlation rules and detect advanced persistent threats",
                    "Conduct web & API penetration testing using Burp Suite and OWASP",
                    "Automate incident response playbooks with SOAR scripting",
                    "Audit cloud security posture (CSPM) across AWS & Azure",
                    "Run red team attack simulations and architect defensive mitigations"
                  ].map((feat, idx) => (
                ...
                <div className="p-4 rounded-xl bg-[#FAF8F3] border border-[#121212]/10 space-y-1.5">
                  ...
                  <p className="font-sans text-xs text-[#555555] leading-relaxed">
                    Live cyber ranges, hands-on packet inspection, red-on-blue adversarial battles, and direct mentorship from enterprise CISOs.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="flex flex-col items-start space-y-3 max-w-3xl">
              ...
              <h2 className="font-bebas text-3xl sm:text-4xl md:text-[46px] tracking-wide text-[#121212] uppercase leading-[1.05]">
                16 MODULES. FROM THREAT FOUNDATIONS TO SYSTEM DEFENSE.
              </h2>
        ...
        <div className="mx-auto max-w-7xl w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <p className="font-sans text-[14.5px] sm:text-base leading-relaxed text-[#555555]">
                Submit your information to connect with our academic admissions team. We will contact you as soon as possible to provide the full 16-module curriculum, cyber range specifications, and cohort schedules.
              </p>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="p-4 rounded-xl bg-white border border-[#121212]/10 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#121212] uppercase tracking-wider font-sans">
                    ...
                    For Enterprise Defense Teams
                  </div>
                  <p className="font-sans text-xs text-[#666666] leading-relaxed">
                    Custom cohort tracks for engineering teams moving into SOC operations, threat intelligence, and red-on-blue defensive testing.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border-2 border-[#121212]/15 p-6 sm:p-8 md:p-10 shadow-xl space-y-6">
                ...
                <div className="border-b border-[#121212]/10 pb-4">
                  <h3 className="font-bebas text-2xl sm:text-3xl text-[#121212] uppercase tracking-wide">
                    CYBER SECURITY BOOTCAMP ENQUIRY
                  </h3>
                  ...
                  <div className="py-10 text-center space-y-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="font-sans text-sm text-[#555555] max-w-md mx-auto leading-relaxed">
                        Thank you for your interest in the Cyber Security Bootcamp. <strong>Our admissions team will contact you as soon as possible</strong> with the complete syllabus, admission guidelines, and cohort schedule.
                      </p>
                    </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 font-sans text-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          placeholder="e.g. TechCorp / Security Team"
                          className="w-full px-3.5 py-2.5 rounded-lg border border-[#121212]/20 focus:border-[#CF5A30] focus:ring-1 focus:ring-[#CF5A30] outline-none transition-colors"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your background (e.g. SOC analyst, network engineer, pentester) and what you aim to build..."
      ...
      <section className="bg-[#1C1C1E] text-[#F5F2EB] py-12 sm:py-16 px-4 sm:px-6 md:px-12 text-center border-t border-[#121212]">
        <div className="mx-auto max-w-3xl space-y-4">
          ...
          <p className="font-sans text-xs sm:text-sm text-[#A1A1AA] max-w-xl mx-auto">
            Discover our full portfolio across Robotics, AI Engineering, and Cloud &amp; Platform Architectures.
          </p>
