        ...
        <div className="mx-auto max-w-7xl w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <p className="font-sans text-[14.5px] sm:text-base leading-relaxed text-[#555555]">
                Submit your information to connect with our academic admissions team. We will contact you as soon as possible to provide the full 16-module curriculum, cloud lab architectures, and corporate cohort schedules.
              </p>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="p-4 rounded-xl bg-white border border-[#121212]/10 space-y-2">
                  ...
                  <p className="font-sans text-xs text-[#666666] leading-relaxed">
                    Custom cohort tracks for engineering teams moving into cloud platforms, platform engineering, and high-throughput LLM architectures.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border-2 border-[#121212]/15 p-6 sm:p-8 md:p-10 shadow-xl space-y-6">
                ...
                <div className="border-b border-[#121212]/10 pb-4">
                  <h3 className="font-bebas text-2xl sm:text-3xl text-[#121212] uppercase tracking-wide">
                    AI ENGINEERING BOOTCAMP ENQUIRY
                  </h3>
                  ...
                  <div className="py-10 text-center space-y-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="font-sans text-sm text-[#555555] max-w-md mx-auto leading-relaxed">
                        Thank you for your interest in the AI Engineering Bootcamp. <strong>Our admissions team will contact you as soon as possible</strong> with the complete syllabus, admission guidelines, and cohort schedule.
                      </p>
                    </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 font-sans text-sm">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your background (e.g. DevOps, platform engineering, distributed systems) and what you aim to build..."
      ...
      <section className="bg-[#1C1C1E] text-[#F5F2EB] py-12 sm:py-16 px-4 sm:px-6 md:px-12 text-center border-t border-[#121212]">
        <div className="mx-auto max-w-3xl space-y-4">
          ...
          <p className="font-sans text-xs sm:text-sm text-[#A1A1AA] max-w-xl mx-auto">
            Discover our full portfolio across Robotics, Cyber Security, and Cloud &amp; Platform Architectures.
          </p>
